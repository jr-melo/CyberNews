            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                    <a class="btn bg-gradient-success" href="{{ url('/admin/roles/create') }}"
                      role="button">Crear Nuevo Rol</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                  ...
                                  <div class="d-flex">
                                    <ul class="list-inline center mx-auto justify-content-center m-0">
                                        ...
                                        <li class="list-inline-item">
                                          ...
                                          {{-- <li class="list-inline-item">
                                            <a class="nav-link"
                                               href="{{ url('/admin/roles/' . $role->id ) . '/delete' }}"
                                               role="button"><i class="fas fa-trash-alt"></i></a>
                                          </li> --}}
                                        <li class="list-inline-item">
                                          <a class="nav-link" href="#" role="button"
                                            onclick="deleteModelRecord({{$role->id}})"><i
                                            class="fas fa-trash-alt"></i></a>
                                          <pre delete-dialog-model="deleteModelRecord" class="d-none">

                                            <form id="deleteModelRecord" name="delteModelRecord" action="{{ url('/admin/roles/')}}" method="POST">
                                                @method('DELETE')
                                                @csrf
                                            </form>
