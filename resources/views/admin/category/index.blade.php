                                ...
                                <tbody class="justify-content-center">
                                    @foreach ($categorys as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" value="false" name='imageCheck' id="imageCheck"
                                                    disabled="disabled" {{-- Valida si existe imagen para el checkbox --}}
                                                    {{ is_null($category->cat_image) ? '' : 'checked' }} />
                                            </td>
                                            <td>
                                                <div class="d-flex">
